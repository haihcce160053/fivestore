<%-- Document : productManagement Created on : Mar 2, 2023, 2:56:02 PM Author : Hoang Liem --%>
                    ...
                    <%@page import="java.util.Locale" %>
                        <%@page import="java.sql.ResultSet" %>
                            <%@page import="com.daos.ProductDAO" %>
                                ...
                                <body>
                                    <% String username=(String) session.getAttribute("username"); AccountDAO daoAc=new
                                        AccountDAO(); Account ac=daoAc.getAccount(username); //Init product dao
                                        ProductDAO dao=new ProductDAO(); //Get message from controller String
                                                    ...
                                                    <div class="container-fluid">
                                                        ...
                                                        <div class="collapse navbar-collapse" id="navbarText">
                                                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                                                <% if (ac !=null &&
                                                                    (ac.getAccountTypeId()).equalsIgnoreCase("AD")) { %>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" href="/Account/Management/<%=ac.getUsername()%>" style="color:#9FA6B2;">Account
                                                                            Management</a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" href="/Statistics" style="color:#9FA6B2;">Revenue
                                                                            statistics</a>
                                                                    </li>
                                                                ...
                                                                <% } else { %>
                                                                    ...
                                                                    <% } if (ac==null ||
                                                                        ...
                                                                        <button id="view-cart-btn" type="button" class="btn me-3" style="background-color: #20283F; color: white">
                                                                            MY CART <span id="cart-badge"
                                                                                class="badge badge-light"
                                                                                style="position: relative; top: -2px; right: -10px;">0</span>
                                                                        </button>
                                                                        <% } if ((ac !=null) &&
                                                                            (!ac.getAccountTypeId().equalsIgnoreCase("AD")))
                                                                            { OrderDAO daoorder=new OrderDAO(); int
                                                                            countOfOrder=daoorder.getNumberOrderByUsername(ac.getUsername());
                                                                            %>
                                                                            <button id="view-purchase-btn" type="button" class="btn me-3" style="background-color: #20283F; color: white" onclick="location.href = '/Account/Order/<%= ac.getUsername()%>'">
                                                                                MY Purchase<span id="cart-badge"
                                                                                    class="badge badge-light"
                                                                                    style="position: relative; top: -2px; right: -10px;">
                                                                                    <%=countOfOrder%>
                                                                                </span>
                                                                            </button>
                                                                            <% }%>
                                        ...
                                        <main>
                                            <div class="container" style="margin-top: 20px;">
                                                    ...
                                                    <div class="search-buttons">
                                                        <div class="select-container">
                                                            <select class="form-control" id="AllSelect">
                                                                ...
                                                                <option value="Sleep Deprivation">Sleep Deprivation
                                                                </option>
                                                                <option value="Weight">Weight</option>
                                                            </select>
                                                        </div>
                                                        <a href="/Product/Add/<%= ac.getUsername()%>"><button
                                                                class="btn btn-primary">Add New Product</button></a>
                                                    </div>
                                                </div>
                                                <ul class="responsive-table">
                                                    ...
                                                    <% ResultSet rs=dao.getAll(); while (rs.next()) { %>
                                                        ...
                                                        <li class="table-row list">
                                                            ...
                                                            <%String
                                                                nameOfTypeProduct=dao.nameOfTypeProduct(rs.getString("ProductTypeID"));%>
                                                                ...
                                                                <% NumberFormat
                                                                    format=NumberFormat.getCurrencyInstance(new
                                                                    Locale("vi", "VN" )); String
                                                                    formattedPrice=format.format(rs.getInt("Price")).replace("?", "VND"
                                                                    ).replaceAll("\\s", "" ); %>
                                                                    ...
                                                                    <div class="col col-11" data-label="Action">
                                                                        <a href="/Product/Edit/<%= rs.getString(" ProductID ")%>" class="edit" title="Edit" data-toggle="tooltip"><i
                                                                                class="fas fa-edit"></i></a>
                                                                        <a href="/Product/Delete/<%= rs.getString(" ProductID ")%>" class="delete" title="Delete" data-toggle="tooltip"><i
